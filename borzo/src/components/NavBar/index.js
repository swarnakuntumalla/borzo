    ...
    return(
        <div className='pt-2 drop-shadow-2xl flex flex-row justify-between text-sm'>
            ...
            <div className='flex flex-row mt-2 font-bold'>
                <p className='hover:text-blue-600 cursor-pointer mr-6 mt-2'>Become a courier</p>
                <p className='hover:text-blue-600 cursor-pointer mr-6 mt-2'>Chat bot</p>
                <button className='rounded-full h-10 border-2 border-solid mr-6 pr-4 pl-4 hover:bg-blue-600 hover:text-white'>Order Delivery</button>
